...
// total kelas
 ...
 $totalKelas = mysqli_fetch_assoc($qKelas)['total'] ?? 0;

// total pelanggaran
 $qPelanggaran = mysqli_query($conn, "SELECT COUNT(*) AS total FROM pelanggaran");
 $totalPelanggaran = mysqli_fetch_assoc($qPelanggaran)['total'] ?? 0;

// pelanggaran 7 hari terakhir
 $q7Hari = mysqli_query($conn, "SELECT COUNT(*) AS total FROM kedisiplinan WHERE tanggal_kejadian >= DATE_SUB(CURDATE(), INTERVAL 7 DAY)");
 $pelanggaran7Hari = mysqli_fetch_assoc($q7Hari)['total'] ?? 0;

// tabel pelanggaran terbaru (FILTER: HANYA SISWA AKTIF)
 $sqlTerbaru = "SELECT s.nama_siswa, k.nama_kelas, p.nama_pelanggaran, kd.poin, kd.tanggal_kejadian FROM kedisiplinan kd JOIN siswa s ON kd.id_siswa = s.id_siswa JOIN kelas k ON s.id_kelas = k.id_kelas JOIN pelanggaran p ON kd.id_pelanggaran = p.id_pelanggaran WHERE s.status = 'aktif' ORDER BY kd.tanggal_kejadian DESC LIMIT 5";
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu">
            <a href="dashboardkaprog.php" class="active">
                <i class='bx bx-grid-alt'></i> Dashboard
            </a>
            <a href="datasiswakaprog.php">
        ...
        <div class="content">
            ...
            <div class="cards">
                ...
                <div class="card">
                    ...
                    <div class="icon green"><i class='bx bx-book-alt'></i></div>
                </div>
